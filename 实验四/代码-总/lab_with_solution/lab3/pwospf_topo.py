...
def set_default_route(host):
    ...
    if(host.name == 'server1'):
        routerip = IP_SETTING['router2-eth2']
    elif(host.name == 'server2'):
        routerip = IP_SETTING['router3-eth2']
    elif(host.name == 'client'):
        routerip = IP_SETTING['router1-eth1']
